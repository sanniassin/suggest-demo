...
exports.getSearchItems = exports.getSuggestItems = exports.fakeSuggestItems = void 0;
var fakeSuggestItems = ['Apple', 'Orange', 'Mango', 'Blackberry', 'Pineapple', 'Strawberry'];
exports.fakeSuggestItems = fakeSuggestItems;
var fakeSearchItems = ['An apple is a sweet, edible fruit produced by an apple tree (Malus pumila). Apple trees are cultivated worldwide as a fruit tree, and is the most widely grown species in the genus Malus.', 'The orange is the fruit of the citrus species Citrus × sinensis in the family Rutaceae.[1] It is also called sweet orange, to distinguish it from the related Citrus × aurantium, referred to as bitter orange.', 'Mangoes are juicy stone fruit (drupe) from numerous species of tropical trees belonging to the flowering plant genus Mangifera, cultivated mostly for their edible fruit.', 'The blackberry is an edible fruit produced by many species in the genus Rubus in the family Rosaceae, hybrids among these species within the subgenus Rubus, and hybrids between the subgenera Rubus and Idaeobatus.', 'The pineapple (Ananas comosus) is a tropical plant with an edible multiple fruit consisting of coalesced berries, also called pineapples,[2][3] and the most economically significant plant in the Bromeliaceae family.', 'The garden strawberry (or simply strawberry; Fragaria × ananassa)[1] is a widely grown hybrid species of the genus Fragaria, collectively known as the strawberries. It is cultivated worldwide for its fruit.'];

var getRandomInt = function getRandomInt(min, max) {
  return Math.floor(Math.random() * (max - min + 1)) + min;
};

var getSuggestItems = function getSuggestItems(query) {
  query = query.toLowerCase();
  var result = fakeSuggestItems.filter(function (item) {
...
exports.getSuggestItems = getSuggestItems;

var getSearchItems = function getSearchItems(query) {
  query = query.toLowerCase();
  var result = fakeSearchItems.filter(function (item) {
    return item.toLowerCase().includes(query);
...
exports.KEY_ESCAPE = exports.KEY_ENTER = exports.KEY_ARROW_RIGHT = exports.KEY_ARROW_LEFT = exports.KEY_ARROW_DOWN = exports.KEY_ARROW_UP = void 0;
var KEY_ARROW_UP = 38;
...
var _react = _interopRequireDefault(__webpack_require__(126));

var _reactDom = _interopRequireDefault(__webpack_require__(346));

var _processQuery = __webpack_require__(330);

var _Input = _interopRequireDefault(__webpack_require__(360));
...
function (_React$Component) {
  ...
  function App() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "suggestCache", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {}
      ...
      value: function value(_value) {
        _this.setState({
          searchQuery: _value,
          lastEnteredQuery: _value,
          waitingForSuggest: !!_value,
          searching: false,
          searchItems: null
        }, function () {
          _this.loadSuggest(_value);
        });
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "loadSuggest", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(query) {
        if (!query) {
          _this.onSuggestLoaded(null);

          return;
        }

        if (_this.suggestCache[query]) {
          _this.onSuggestLoaded(_this.suggestCache[query]);

          return;
        }

        (0, _processQuery.getSuggestItems)(query).then(function (res) {
          _this.suggestCache[query] = res; // do nothing if input value has changed

          if (query !== _this.state.searchQuery) {
            return;
          }

          _this.onSuggestLoaded(res);
        });
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "onSuggestLoaded", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(res) {
        if (res && !_this.state.waitingForSuggest) {
          return;
        }
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "onSuggestItemSelect", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(query) {
        ...
        _this.loadSearchItems(query);
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "onSuggestItemHover", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(itemIndex, event) {
        if (!event || event.type !== 'keydown') {
          return;
        }

        var query = _this.state.lastEnteredQuery;

        if (itemIndex !== null) {
          query = _this.state.suggestItems[itemIndex];
        }
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "loadSearchItems", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        ...
        (0, _processQuery.getSearchItems)(query).then(function (res) {
          // do nothing if input value has changed
          if (query !== _this.state.searchQuery) {
            return;
          }

          _this.onSearchItemsLoaded(res);
        });
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "onSearchItemsLoaded", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(res) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      var _state = this.state,
          ...
          suggestItems = _state.suggestItems,
          searching = _state.searching,
          searchItems = _state.searchItems;
      return _react.default.createElement("div", {
      ...
      }, searchItems.length ? _react.default.createElement("span", null, "Results for ", _react.default.createElement("strong", null, searchQuery), ":") : _react.default.createElement("span", null, "Nothing found for ", _react.default.createElement("strong", null, searchQuery))), searchItems.map(function (item, i) {
        return _react.default.createElement("div", {
        ...
        className: "suggest-hint__intro"
      }, "Suggest words:"), " ", _processQuery.fakeSuggestItems.join(', ')));
    }
  }]);
...
var getActiveElement = __webpack_require__(350);
var shallowEqual = __webpack_require__(351);
...
var _Input = _interopRequireDefault(__webpack_require__(361));
...
var _classnames = _interopRequireDefault(__webpack_require__(331));

var _Spinner = _interopRequireDefault(__webpack_require__(362));

var _InputSuggest = _interopRequireDefault(__webpack_require__(364));
...
function (_React$PureComponent) {
  ...
  function Input() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Input.__proto__ || Object.getPrototypeOf(Input)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "onFocus", {
      configurable: true,
      enumerable: true,
      writable: true,
      ...
      value: function value(event) {
        if (event.key === 'Enter') {
          if (typeof _this.props.onEnterPress === 'function') {
            _this.props.onEnterPress();
          }
        }

        if (event.key === 'Escape') {
          if (typeof _this.props.onEscPress === 'function') {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          onEscPress = _props.onEscPress,
          loading = _props.loading,
          suggestItems = _props.suggestItems,
      ...
      return _react.default.createElement("div", {
        ...
        items: suggestItems,
        onItemSelect: onSuggestItemSelect,
        onItemHover: onSuggestItemHover
      }));
    }
  }]);
...
var _Spinner = _interopRequireDefault(__webpack_require__(363));
...
function (_React$PureComponent) {
  ...
  _createClass(Spinner, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)('spinner-container', className);
      return _react.default.createElement("span", {
        ...
        cy: "9",
        r: "9",
        stroke: "url(#spinnerGradient-1)"
      }), _react.default.createElement("circle", {
        cx: "9",
        cy: "9",
        r: "9",
        stroke: "url(#spinnerGradient-2)"
      })))));
    }
  }]);
...
var _keys = __webpack_require__(335);
...
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(InputSuggest, _React$PureComponent);
  ...
  function InputSuggest() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = InputSuggest.__proto__ || Object.getPrototypeOf(InputSuggest)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "enableDocumentListeners", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "disableDocumentListeners", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "onItemHover", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(index, event) {
        _this.setState({
          selectedIndex: index
        });

        if (typeof _this.props.onItemHover === 'function') {
          _this.props.onItemHover(index, event);
        }
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "onItemSelect", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(_value) {
        if (typeof _this.props.onItemSelect === 'function') {
          _this.props.onItemSelect(_value);
        }
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "handleDocumentKeydown", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(event) {
        ...
        switch (keyCode) {
          case _keys.KEY_ARROW_DOWN:
            ...
            _this.onItemHover(newIndex, event);

            break;

          case _keys.KEY_ARROW_UP:
            event.preventDefault();
          ...
          case _keys.KEY_ENTER:
            if (_this.state.selectedIndex === null) {
              ...
              var item = _this.props.items[_this.state.selectedIndex];
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "handleDocumentClick", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(event) {
        ...
        var _assertThisInitialize = _assertThisInitialized(_this),
            suggest = _assertThisInitialize.suggest;
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        return _react.default.createElement("div", {
          className: classes,
          key: i,
          onMouseDown: _this2.onItemSelect.bind(_this2, label),
          onMouseEnter: _this2.onItemHover.bind(_this2, i)
        }, _react.default.createElement("div", {
          className: "input-suggest__item-label"
        }, label));
      }));
    }
  }]);
